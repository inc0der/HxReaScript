...
extern class Core {
   ...
   */
  public static function AddProjectMarker(project: ReaProject, isRegion: Bool, position: Int, regionEnd: Int,
   ...
   *  Adds a project marker. Supply an id >=0  if you want a particular index number,
      ...
      * @return number | The index of the created marker/region, or -1 on failure.
   */
  public static function AddProjectMarkerWithColor(project: ReaProject, isRegion: Bool, position: Int, regionEnd: Int,
    name: String, id: Int, color: Color): Int;

  public static function AddProjectMarker2(project: ReaProject, isRegion: Bool, position: Int, regionEnd: Int,
    name: String, id: Int, color: Color): Int;
  ...
  public static function AddTempoTimeSigMarker(proj: ReaProject, timepos: Float, bpm: Float, timesig_num: Int,
    timesig_denom: Int, lineartempochange: Bool): Int;
  ...
  public static function ApplyNudge(project: ReaProject, nudgeFlag: Int, nudgeWhat: Int, nudgeUnits: Int,
    value: Float, reverse: Bool, copies: Int): Bool;
  ...
  public static function CalculateNormalization(source: PCMSource, normalizeTo: Float, normalizeTarget: Float,
    normalizeStart: Float, normalizeEnd: Float): Float;
